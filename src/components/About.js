          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                ...
                className Name es that we use to style each element. These
                className Name es control the overall appearance, as well as the
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                ...
                appropriate className Name es that we use to style each element.
                These className Name es control the overall appearance, as well
